...
const Gallery = () => {
  ...
  return (
    <div className="relative ">
      ...
      <p className="w-full text-center absolute  top-24 md:top-6 text-4xl font-bold text-gray-400">
        NEW EVENTS
      </p>
      <p className="w-full text-center absolute  top-36 md:top-16 text-2xl sm:text-sm text-gray-400">
        رویداد های جدید
      </p>
